...
public class TreeUse {
	...
	public static void printPathSum(BinaryTreeNode<Integer> root, int k, String str)
	{
		if (root == null) {
			return;
		}
		if ((k - root.data) == 0 && (root.right == null && root.left == null)) {
			str += root.data;
			System.out.println(str);
			return;
		}
		str += root.data + " ";
		printPathSum(root.left, k - root.data, str);
		printPathSum(root.right, k - root.data, str);
	}

	
	public static void printPathSum(BinaryTreeNode<Integer> root, int k)
	{
		String str = "";
		printPathSum(root, k, str);
	}
